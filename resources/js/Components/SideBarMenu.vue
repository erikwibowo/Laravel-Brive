...
<template>
    <div class="text-gray-300 pt-5 pb-20">
        ...
        <ul class="space-y-2 my-4">
            <li class="bg-primary rounded-lg hover:bg-primary"
                :class="{ 'text-white bg-gray-700': !route().current('dashboard') }">
            ...
            <li class="bg-primary rounded-lg hover:bg-primary"
                :class="{ 'text-white bg-gray-700': !route().current('user.index') }">
