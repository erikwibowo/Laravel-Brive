...
<template>
    <div class="text-gray-300 pt-5 pb-20">
        ...
        <ul class="space-y-2 my-4">
            <li class="bg-gray-700 rounded-lg hover:bg-primary"
                :class="{ 'text-white bg-indigo-600': route().current('dashboard') }">
            ...
            <li class="bg-gray-700 rounded-lg hover:bg-primary"
                :class="{ 'text-white bg-indigo-600': route().current('user.index') }">
