...
<template>
    <div class="hidden lg:flex">
        <aside
            class="fixed lg:flex flex-col h-screen overflow-hidden w-64 bg-gray-800 dark:bg-gray-900 dark:border-r dark:border-gray-800">
    ...
    <TransitionRoot :show="open">
        <Dialog as="div" @close="emit('close')" class="fixed inset-0 z-10 flex lg:hidden">
